(() => {
  ...
  dialog.innerHTML = `
    ...
    <div class="rules-content">
      ...
      <section><h3>Сезонные номинации</h3><p>Для участия в номинациях определённой роли игрок должен провести минимум <strong>3 карты на этой роли за сезон</strong>.</p><p>Игрок может участвовать одновременно в core- и support-номинациях, если выполнил минимальное требование по обеим ролям.</p><div class="rules-roles"><div><h4>Core-номинации</h4><ul><li>Лучший KDA.</li><li>Лучший нетворс.</li><li>Лучший средний урон за карту.</li></ul></div><div><h4>Support-номинации</h4><ul><li>Лучший KDA.</li><li>Лучший расход ресурсов на поддержку.</li><li>Лучший охотник за вардами.</li></ul></div></div><p>Средние показатели рассчитываются на основе сыгранных карт. Средний урон определяется как общий нанесённый урон, разделённый на количество сыгранных карт, без нормализации по продолжительности игры.</p></section>
